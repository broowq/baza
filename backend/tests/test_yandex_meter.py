...
def test_apply_plan_limits_sets_yandex_caps():
    expected = {
        ...
        PlanType.pro: 6000, PlanType.team: 20000,
    }
...
def test_yandex_requests_remaining_boundary():
    ...
    assert quota.yandex_requests_remaining(o) == 6000
    o.yandex_requests_used_current_month = 5999
    assert quota.yandex_requests_remaining(o) == 1
    o.yandex_requests_used_current_month = 6000
