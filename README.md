...
| `YOOKASSA_SHOP_ID` / `YOOKASSA_SECRET_KEY` | ЮKassa для платежей (РФ) | ❌ |
...
| Тариф | Лидов/мес | Проектов | Пользователей | Цена/мес |
|-------|-----------|----------|---------------|----------|
| Free | 0 | 1 | 1 | — |
| Starter | 5 000 | 5 | 3 | 3 900 ₽ |
| Pro | 25 000 | 20 | 10 | 12 900 ₽ |
| Business | 100 000 | 100 | 50 | 34 900 ₽ |
...
```bash
make test          # Unit-тесты (≈290): парсер, scoring, склад, обогащение, биллинг, периодика
