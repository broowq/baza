...
const variantClasses: Record<NonNullable<Props["variant"]>, string> = {
  default:
    "rounded-2xl border border-[var(--line-2)] bg-[var(--surface-input)] p-5 backdrop-blur-xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)]",
  hero:
    "rounded-3xl border border-[var(--line-2)] bg-[var(--surface-2)] p-8 backdrop-blur-2xl shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08)]",
  warning:
  ...
  return (
    <div
      className={cn(
        ...
        hover &&
          "transition-colors duration-200 hover:bg-[var(--surface-hover)] hover:border-[var(--line-3)]",
...
export function GlassCardEyebrow({
  ...
  return (
    <span
      className={cn(
        "text-[11px] font-medium uppercase tracking-wider text-[var(--t-48)]",
        className,
      )}
      {...props}
    >
...
export function GlassCardTitle({
  ...
  return (
    <h3
      className={cn(
        "text-base font-medium tracking-tight text-[var(--t-100)]",
        className,
      )}
      {...props}
    >
